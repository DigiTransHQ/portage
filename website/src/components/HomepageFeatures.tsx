...
const opaForthVideoContent = (
  <div className='opa-video-item'>
  <h4>Portage on AWS at BackstageCon 2023</h4>
...
const opaFifthVideoContent = (
  <div className='opa-video-item'>
  <h4>Portage on AWS Tech Playlist</h4>
...
const carouselContent = (
  ...
  <Carousel.Item>
    <Carousel.Caption style={{minHeight:'120px'}}>
      ...
      <p>Portage on AWS is now integrated with both GitHub & Gitlab Source control <br/>You can even extend it to more git providers. Read more <a href="/docs/integration/git" >-->here</a></p>
    </Carousel.Caption>
  </Carousel.Item>
  <Carousel.Item>
    <Carousel.Caption style={{minHeight:'120px'}}>
  ...
  <Carousel.Item>
    <Carousel.Caption style={{minHeight:'120px'}}>
      ...
      <p>Step by Step <a href="/docs/integration/control-tower-and-aft" >Documentation</a> how to integrate Portage on AWS <br/> with AWS Control Tower and AFT (Account Factory for Terraform)</p>
    </Carousel.Caption>
  </Carousel.Item>
...
const opaDescription : FeatureItem[] = [
  {
    ...
    description: (
      <div className="opaDescription">
       <b>Portage on AWS </b> (Previously known as OPA on AWS) is an open source reference implementation that ties together AWS services into an enterprise-ready offering. By abstracting AWS services, Portage on AWS allows application developers to focus on what they do best – write application logic! <br/> <br/> Platform engineering teams can promote best practices at-scale, while providing a productive and pleasurable experience for non-cloud developers  <br/> <br/> Portage on AWS reduces the time to build your customized developer portal by up to 80%
      </div>
    ),
  },
]
