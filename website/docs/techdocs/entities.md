...
Portage on AWS uses some Backstage out of the box entities but also introduces two new entities in the software catalog.
...
:::info
AWS Environment Entity Definition: [AWSEnvironmentEntityV1.ts](https://github.com/DigiTransHQ/portage/blob/main/backstage-plugins/plugins/aws-apps-backend/src/model/kind/AWSEnvironmentEntityV1.ts)
:::
...
:::info
AWS Environment Processor code: [AWSEnvironmentEntitiesProcessor.ts](https://github.com/DigiTransHQ/portage/blob/main/backstage-plugins/plugins/aws-apps-backend/src/model/processor/AWSEnvironmentEntitiesProcessor.ts)
:::
...
:::info
AWS Environment Provider Entity Definition: [AWSEnvironmentProviderEntityV1.ts](https://github.com/DigiTransHQ/portage/blob/main/backstage-plugins/plugins/aws-apps-backend/src/model/kind/AWSEnvironmentProviderEntityV1.ts)
:::
...
:::info
AWS Environment Provider Processor code: [AWSEnvironmentProviderEntitiesProcessor.ts](https://github.com/DigiTransHQ/portage/blob/main/backstage-plugins/plugins/aws-apps-backend/src/model/processor/AWSEnvironmentProviderEntitiesProcessor.ts)
:::
